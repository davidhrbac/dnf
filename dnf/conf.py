...
* optionally asserting no value is overridden once it has been applied somewhere
  (e.g. do not let a new repo be initialized with different global cache path
...
class Cache(object):
    ...
    def cachedir(self):
        if util.am_i_root():
            return self._retdir(self.cachedir)
