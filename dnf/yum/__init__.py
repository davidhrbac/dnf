...
class YumBase(object):
    ...
    def readRepoConfig(self, parser, section):
        ...
        repo.cachedir = self.cache_c.cachedir()
        repo.fallback_cachedir = self.cache_c.fallback_cachedir()
    ...
    def add_enable_repo(self, repoid, baseurls=[], mirrorlist=None, **kwargs):
        ...
        newrepo.cachedir = self.cache_c.cachedir()
        newrepo.fallback_cachedir = self.cache_c.fallback_cachedir()
